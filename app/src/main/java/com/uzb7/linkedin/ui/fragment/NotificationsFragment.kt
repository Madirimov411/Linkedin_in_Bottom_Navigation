...
import com.uzb7.linkedin.databinding.FragmentNotificationsBinding
    ...
    private fun initViews() {
        binding.apply {
            bClick.setOnClickListener {
                Toast.makeText(requireContext(), "You are in the Notifications fragment", Toast.LENGTH_SHORT).show()
            }
        }
    }
